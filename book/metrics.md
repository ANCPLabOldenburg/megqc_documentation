...
There are 2 different types of sensors in MEG sensors. Each sensor might contain one type of channel or both. The sensor labels help you distinguish between them:
