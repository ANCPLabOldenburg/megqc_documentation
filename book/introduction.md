...
The MEGqc pipeline can be used in two ways: through a via a **command-line interface (CLI)** or a **graphical user interface (GUI).** This documentation covers the [installation](./installation) and tutorial for both options.
